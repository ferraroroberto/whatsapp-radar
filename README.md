...
- `GET /api/tts/health`, `POST /api/tts/speak` — reachability probe plus ephemeral `orpheus-tts` headerless PCM16 stream for manual summary playback (#94)
- `GET`/`POST /api/config`
